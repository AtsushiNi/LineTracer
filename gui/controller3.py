...
class MainScreen3(BoxLayout):
    ...
    def handle_submit(self, value):
        ...
        if ',' in input_value:
            ...
            commands.append("a")
            commands.append("I")
            commands.append(params31[-1])
            commands.append("a")
            commands.append("J")
            commands.append(params31[-2])
            commands.append("a")
            commands.append("K")
            commands.append(params32[-1])
            commands.append("a")
            commands.append("L")
            commands.append(params32[-2])
            commands.append("a")
            commands.append("M")
            commands.append(params41[-1])
            commands.append("a")
            commands.append("N")
            commands.append(params41[-2])
            commands.append("a")
            commands.append("O")
            commands.append(params42[-1])
            commands.append("a")
            commands.append("P")
            commands.append(params42[-2])
            commands.append("a")
